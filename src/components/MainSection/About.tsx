...
export default function AboutSection() {
    ...
    return (
        <div ref={sectionRef} className={`dm-root ${isIntersecting ? "start-animation" : ""}`}>
                ...
                <div className="dm-text">
                    ...
                    <div className="dm-features-row dm-desktop-only">
                        <motion.div
                            ...
                            <span className="dm-feature-label">SEA-FACING<br />RESIDENCES</span>
                        </motion.div>
                        ...
                        <motion.div
                            ...
                            <span className="dm-feature-label">CURATED<br />LUXURY</span>
                        </motion.div>
                        <span className="dm-feature-divider"></span>
                        <motion.div
                            className="dm-feature-item"
                            ...
                            <span className="dm-feature-label">EXCEPTIONAL<br />AMENITIES</span>
                        </motion.div>
                        ...
                        <motion.div
                            ...
                            <span className="dm-feature-label">TIMELESS<br />DESIGN</span>
                        </motion.div>
