...
export default function Slider() {
  ...
  const [detailState, setDetailState] = useState<"closed" | "opening" | "open" | "closing">("closed");
  ...
  return (
    <>
      ...
      >
        ...
        <div className="cards-wrapper">
          {slides.map((slide, index) => {
            ...
            const isActiveSource = activeSlide?.id === slide.id && detailState !== "closed";
            return (
              <div
                key={slide.id}
              ...
              >
                ...
                <div className="card-content">
                  ...
                  {position === 1 && <div className="bottom-title">{slide.bottomTitle}</div>}
                </div>
              </div>
            );
          })}
      ...
      {activeSlide && (
        <div className={`detail-page detail-${detailState}`} style={detailStyle}>
          <img src={activeSlide.image} alt={activeSlide.heading} className="detail-bg" loading="lazy" decoding="async" />
          ...
          <div className="detail-content">
            <div className="detail-left">
              ...
              <div className="detail-description"><p>{activeSlide.description}</p></div>
              ...
              <div className="feature-grid">
                ...
                <div className="feature-card">
                  <div className="feature-icon"><FaWater /></div>
                ...
                <div className="feature-card">
                  <div className="feature-icon"><FaBed /></div>
              ...
              <div className="price-box">
                <div className="price-left">
                  ...
                  <h2 className="price-number">{activeSlide.price} <span>CR</span></h2>
                  <p className="tc-text">T&C APPLY</p>
                </div>
                <div className="price-divider" />
                <div className="price-mini">
                  <div className="price-top">
                    <div className="mini-icon"><FaBed /></div>
                ...
                <div className="price-mini">
                  <div className="price-top">
                    <div className="mini-icon"><FaBath /></div>
              ...
              <div className="detail-buttons">
                <button className="gold-btn" onClick={() => setIsFormOpen(true)}>
                  <FaMapMarkerAlt /> Book a Site Visit
                </button>
                <button className="outline-btn" onClick={() => setIsFormOpen(true)}>
