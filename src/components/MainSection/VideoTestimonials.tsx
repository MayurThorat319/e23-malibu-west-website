...
export default function VideoTestimonials() {
  ...
  useEffect(() => {
    const onScroll = () => {
      ...
      section.style.transform = `translate3d(${-progress * 65}vw, ${-progress * 40}vh, 0)`;
    };
    onScroll();
              ...
              <div className="video-grid">
                <div className="video-content-div">
                  <div className="overflow-hidden-div">
                    <h2 className="h2-heading">Step Inside with Our Exclusive Video Tours</h2>
                  </div>
                  <div className="vertical-line" />
                  <div className="overflow-hidden-div">
                    <p className="paragraph">
                      Explore every corner of our premium properties through immersive cinematic
                      walkthroughs — get the real feel before you visit.
                    </p>
                  </div>
      ...
      <section id="testimonials" className="testimonial-section">
        <div className="t-container">
          <div className="t-head">
            ...
            <p>
              Stories from homeowners, investors, and partners who trusted us to shape their next
              chapter.
            </p>
          </div>
